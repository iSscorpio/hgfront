...
def init_default_options(app, created_models, verbosity, **kwargs):
    ...
    if SiteOptions in created_models:
        SiteOptions.objects.get_or_create(option_key='site_name', defaults={'option_key':'site_name', 'option_keydesc':'Site Name','option_value':'hgfront Dev Application', 'option_description':'The site name', 'option_active':'1'})
        SiteOptions.objects.get_or_create(option_key='site_url', defaults={'option_key':'site_url', 'option_keydesc':'Site URL','option_value':'http://127.0.0.1:8000/hgfront/', 'option_description':'The URL of the site', 'option_active':'1'})        
        SiteOptions.objects.get_or_create(option_key='site_admin_url', defaults={'option_key':'site_admin_url', 'option_keydesc':'Site Admin URL','option_value':'http://127.0.0.1:8000/admin/', 'option_description':'The URL of the sites admin', 'option_active':'1'})
        SiteOptions.objects.get_or_create(option_key='site_owner', defaults={'option_key':'site_owner', 'option_keydesc':'Site Owner','option_value':'Default Owner', 'option_description':'The name of the site owner', 'option_active':'1'})
        SiteOptions.objects.get_or_create(option_key='site_owner_email', defaults={'option_key':'site_owner_email', 'option_keydesc':'Site Admin URL','option_value':'http://127.0.0.1:8000/admin/', 'option_description':'The URL of the sites admin', 'option_active':'1'})
        SiteOptions.objects.get_or_create(option_key='repo_location', defaults={'option_key':'repo_location', 'option_keydesc':'Repo Location','option_value':'/path/to/repos/', 'option_description':'The location of your repos', 'option_active':'1'})
        SiteOptions.objects.get_or_create(option_key='issues_per_page', defaults={'option_key':'issues_per_page', 'option_keydesc':'Issues Per Page','option_value':'20', 'option_description':'The number of issues to show per page', 'option_active':'1'})
