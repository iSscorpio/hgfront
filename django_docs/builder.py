...
def build_document(text):
    ...
    """
    # The Django web site's implementation also had the following key/value in
    # the settings_overrides dictionary: `'default_reference_context': None`
    # but that seems to cause problems rendering some pages.
